...
@pytest.mark.tt_16903
def test_del_action_delete_child_option(ngcpcfgcli, tmpdir):
    tmpfile = tmpdir.join("tmpfile.txt")
    tmpfile.write('''---
aaa:
  bbb: '123'
...
@pytest.mark.tt_16903
def test_del_action_delete_parent_option(ngcpcfgcli, tmpdir):
    tmpfile = tmpdir.join("tmpfile.txt")
    tmpfile.write('''---
aaa:
  bbb: '123'
...
@pytest.mark.tt_16903
def test_del_action_missing_option(ngcpcfgcli, tmpdir):
    tmpfile = tmpdir.join("tmpfile.txt")
    tmpfile.write('''---
aaa:
  bbb: '123'
