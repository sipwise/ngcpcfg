...
def test_bad_syntax(ngcpcfgcli, tmpdir):
    ...
    regex1 = re.compile(r"NOTE: Check those files for valid syntax and encoding"
                        ".*etc/bad-syntax\.txt\.tt2.*or inspecting temporary "
                        "/tmp/ngcpcfg\.bad-syntax\.txt\.")
    ...
    regex3 = re.compile(r"Error:   file error - parse error - "
                        "input file handle line 1: unexpected end of directive")
