...
def test_ngcpcfg_check_patchtt_customtt_perms(ngcpcfgcli, tmpdir):
    ...
    chmod_base = "chmod 0600 " + path + "/fixtures/repos/templates/etc/"
    ...
    regex1 = re.compile(r"Error: Base file corresponding to customtt/patchtt "
                        "file '.*/case-c.customtt.tt2' not found")
    assert re.search(regex1, out.stderr)

    regex2 = re.compile(r"Error: Base file corresponding to customtt/patchtt "
                        "file '.*/case-c.customtt.tt2' not found")
